package com.xunmaw.design.Util.vec;



import com.xunmaw.design.Util.vec.domain.HiddenNeuron;
import com.xunmaw.design.Util.vec.domain.Neuron;
import com.xunmaw.design.Util.vec.domain.WordNeuron;
import com.xunmaw.design.Util.vec.util.Haffman;
import com.xunmaw.design.Util.vec.util.MapCount;
...
//   * @param neu1
  ...
  public static void main(String[] args) throws IOException {
    ...
    learn.learnFile(new File("D:\\uploads\\test\\one.txt"));
    System.out.println("use time " + (System.currentTimeMillis() - start));
    learn.saveModel(new File("D:\\uploads\\test\\two.model"));
